...
def model_train(cfg):
    ...
    model,infer_model = create_res_tiny_model(input_shape, anchors, num_classes,alpha = alpha, 
                                              weights_path=weight,weight_load=support_weight)
    ...
    m_path = 'yolo3_nano_final.tflite'
